...
class Student(BaseModel):
    ...
    def delete(self, *args, **kwargs):
        """
        Override default delete to perform a soft delete to avoid
        database-level cascade deletes when related tables are missing.
        Use `restore()` to bring the record back.
        """
        self.soft_delete()
