...
const RemarksManager: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            success(t('remarks.created', { defaultValue: 'Remark added successfully!' }));
            setShowModal(false);
            setFormData({
                student: '',
                remark_type: 'NEUTRAL',
            ...
            error(t('remarks.error', { defaultValue: 'Failed to add remark' }));
        }
    };
    ...
    const handleAcknowledge = async (remarkId: number) => {
        try {
            ...
            success(t('remarks.acknowledged', { defaultValue: 'Remark acknowledged!' }));
            fetchRemarks();
        } catch (error) {
    ...
    const handleMarkActionTaken = async (remarkId: number) => {
        ...
        try {
            ...
            success(t('remarks.action_marked', { defaultValue: 'Action marked as taken!' }));
            fetchRemarks();
        } catch (error) {
