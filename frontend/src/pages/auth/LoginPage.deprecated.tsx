...
// Deprecated login page - contexts not available in this legacy file.
// Provide lightweight fallbacks so TypeScript build does not fail.
const useAuth = () => ({ login: async (_: { email: string; password: string }) => { /* noop */ } });
const useTheme = () => ({ branding: { logo_url: null as string | null, primary_color: '#1976D2', secondary_color: '#424242', login_background_url: null as string | null } });
